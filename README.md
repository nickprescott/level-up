...
### Adding activities
Now that you have some skills defined, you can either pre-populate activities that you know you will be doing in the future, or you can skip this and just log the activities as they occur, which will then save them for easier addition in the future.
